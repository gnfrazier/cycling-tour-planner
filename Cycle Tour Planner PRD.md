...
18. Now that Web is explicitly not local-first (item 16), does FR18's "full planning parity with Desktop" still imply any Web offline capability (e.g. service-worker/PWA caching of a signed-in user's own trips), or is Web intentionally online-only, simplifying FR18's scope going into M6?
